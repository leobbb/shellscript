...
cp kernel-3.18/arch/arm64/configs/${BASE_PROJECT}_defconfig kernel-3.18/arch/arm64/configs/${NEW_PROJECT}_defconfig
cp kernel-3.18/arch/arm64/configs/${BASE_PROJECT}_debug_defconfig kernel-3.18/arch/arm64/configs/${NEW_PROJECT}_debug_defconfig
sed -i s/${BASE_PROJECT}/${NEW_PROJECT}/g kernel-3.18/arch/arm64/configs/${NEW_PROJECT}_defconfig
sed -i s/${BASE_PROJECT}/${NEW_PROJECT}/g kernel-3.18/arch/arm64/configs/${NEW_PROJECT}_debug_defconfig
cp kernel-3.18/arch/arm64/boot/dts/${BASE_PROJECT}.dts kernel-3.18/arch/arm64/boot/dts/${NEW_PROJECT}.dts
cp kernel-3.18/arch/arm64/boot/dts/${BASE_PROJECT}_bat_setting.dtsi kernel-3.18/arch/arm64/boot/dts/${NEW_PROJECT}_bat_setting.dtsi
sed -i s/${BASE_PROJECT}/${NEW_PROJECT}/g kernel-3.18/arch/arm64/boot/dts/${NEW_PROJECT}.dts
